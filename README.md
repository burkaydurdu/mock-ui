...
* [`src/mock_ui/`](src/mock_ui/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/mock_ui/core.cljs): contains the SPA entry point, `init`
* [`test/mock_ui/`](test/mock_ui/): test files (ClojureScript,
...
The `debug?` variable in [`config.cljs`](src/cljs/mock_ui/config.cljs) defaults to `true` in
...
```clj
(ns mock-ui.example
  (:require [mock-ui.config :as config])
